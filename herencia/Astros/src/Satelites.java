public class Satelites extends Astros{
    ...
    public Satelites(double  masaDelCuerpo, double  diametroMedio, double  períodoRotaciónHoras, double  períodoTraslaciónHoras, double  distanciaMedia,double distanciaPlaneta, double  orbitaPlaneta, String planetaPerteneciente){
    ...
    public String toString() {
        ...
        sb.append(", el periodo de trastacion es =").append(super.getPeriodoRotacionHoras());
